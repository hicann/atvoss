...
- [2025/11] ATVOS项目首次上线。
## 🚀概述
ATVOSS（Ascend C Templates for Vector Operator Subroutines）是一套基于[Ascend C](https://hiascend.com/cann/ascend-c)开发的Vector算子库，致力于为昇腾硬件上的Vector类融合算子提供极简、高效、高性能、高拓展的编程方式。
