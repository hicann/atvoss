...
若您希望快速体验项目，请访问[快速入门](./docs/quick_start.md)获取简易教程，包括环境搭建、编译执行、本地验证等操作。
...
| 文档 | 说明 |
|------|------|
|[快速入门](./docs/quick_start.md)|快速体验项目的简易教程。|
|[编程指南](./docs/tutorials/developer_guide.md)|使用ATVOSS实现算子开发的教程。|
|[分层设计](./docs/summary.md)|介绍ATVOSS分层模型。|
