...
struct AdssRhsConfig {
    struct AdssRhsCompute {
    ...
    using BlockOp = Atvoss::Ele::BlockBuilder<AdssRhsCompute, ArchTag>;
...
static void Run()
{
    ...
    // --- Step 8: 执行算子 ---
    using DeviceOp = typename AdssRhsConfig<T1, T2>::DeviceOp;
    DeviceOp deviceOp;
