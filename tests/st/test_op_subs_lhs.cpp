...
struct SubsLhsConfig {
    struct SubsLhsCompute {
    ...
    using BlockOp = Atvoss::Ele::BlockBuilder<SubsLhsCompute, ArchTag>;
...
static void Run()
{
    ...
    // --- Step 8: 执行算子 ---
    using DeviceOp = typename SubsLhsConfig<T1, T2>::DeviceOp;
    DeviceOp deviceOp;
