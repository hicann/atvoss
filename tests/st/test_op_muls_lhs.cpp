...
struct MulsLhsConfig {
    struct MulsLhsCompute {
    ...
    using BlockOp = Atvoss::Ele::BlockBuilder<MulsLhsCompute, ArchTag>;
...
static void Run()
{
    ...
    // --- Step 8: 执行算子 ---
    using DeviceOp = typename MulsLhsConfig<T1, T2>::DeviceOp;
    DeviceOp deviceOp;
