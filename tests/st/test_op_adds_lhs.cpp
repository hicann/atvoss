...
struct AddsLhsConfig {
    struct AddsLhsCompute {
    ...
    using BlockOp = Atvoss::Ele::BlockBuilder<AddsLhsCompute, ArchTag>;
...
static void Run()
{
    ...
    // --- Step 8: 执行算子 ---
    using DeviceOp = typename AddsLhsConfig<T1, T2>::DeviceOp;
    DeviceOp deviceOp;
