...
struct MulsRhsConfig {
    struct MulsRhsCompute {
    ...
    using BlockOp = Atvoss::Ele::BlockBuilder<MulsRhsCompute, ArchTag>;
...
static void Run()
{
    ...
    // --- Step 8: 执行算子 ---
    using DeviceOp = typename MulsRhsConfig<T1, T2>::DeviceOp;
    DeviceOp deviceOp;
