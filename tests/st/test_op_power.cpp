...
struct PowerConfig {
    struct PowerCompute {
        ...
        __host_aicore__ constexpr auto Compute() const
        {
            ...
            return (out = Power<3>(in));
        };
    };

    using ArchTag = Atvoss::Arch::DAV_3510;
    using BlockOp = Atvoss::Ele::BlockBuilder<PowerCompute, ArchTag>;
...
static void Run()
{
    ...
    // --- Step 8: 执行算子 ---
    using DeviceOp = typename PowerConfig<T1, T2>::DeviceOp;
    DeviceOp deviceOp;
