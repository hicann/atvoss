...
/*!
 * \file test_compute_cascade.cpp
 * \brief 测试compute表达的scalar和tensor混用
 */
...
struct ComputeTestConfig {
    struct ComputeTestCompute {
        ...
        __host_aicore__ constexpr auto Compute() const
        {
            ...
            auto in2 = Atvoss::PlaceHolder<2, T1, Atvoss::ParamUsage::IN>();
            auto out = Atvoss::PlaceHolder<3, Tensor<T2>, Atvoss::ParamUsage::OUT>();

            return (out = in1 * in2 + in2);
        };
    };
...
static void Run()
{
    ...
    auto arguments = Atvoss::ArgumentsBuilder{}.inputOutput(t1, in2, t3).build();
