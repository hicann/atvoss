...
function get_install_param
    ...
    set -l install_info_key_array Atvoss_Install_Type Atvoss_Feature_Type Atvoss_UserName Atvoss_UserGroup Atvoss_Install_Path_Param Atvoss_Arch_Linux_Path Atvoss_Hetero_Arch_Flag
...
function get_install_dir
    ...
    set -l hetero_arch (get_install_param "Atvoss_Hetero_Arch_Flag" "$install_info")
