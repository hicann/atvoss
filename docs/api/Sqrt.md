...
template<typename T>
__host_aicore__ constexpr auto Sqrt(Expression<T> lhs)

template<typename T>
__host_aicore__ constexpr auto Sqrt(T &&lhs)
```
## 参数说明
...
<tbody>
  ...
  <tr>
    ...
    <td>输入</td>
    <td>NA</td>
    <td>Sqrt操作数，当类型是Expression&lt;T&gt;时，是张量，当类型是T时，是标量</td>
    <td>NA</td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    <td>Expression<OpSqrt<T>></td>
    <td>返回一个OpSqrt的表达式</td>
  </tr>
</tbody>
</table>
