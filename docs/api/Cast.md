...
<tbody>
  ...
  <tr>
    ...
    <td>输入</td>
    <td>NA</td>
    <td>Cast操作数，当类型是Expression&lt;T&gt;时，是张量，当类型是T时，是标量</td>
    <td>NA</td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    <td>Expression<OpCast<castMode, R, T>></td>
    <td>返回一个OpCast的表达式</td>
  </tr>
</tbody>
</table>
...
struct Config {
    struct Compute {
        ...
        __host_aicore__ constexpr auto Compute() const
        {
            ...
            // 🔥🔥🔥 使用示例 🔥🔥🔥
            return (out = Cast<CastMode::CAST_ROUND, OutputDtype>(in));
            // 🔥🔥🔥 使用示例 🔥🔥🔥
        };
    };
};
...
struct Config {
    struct Compute {
        ...
        __host_aicore__ constexpr auto Compute() const
        {
            ...
            // 🔥🔥🔥 使用示例 🔥🔥🔥
            return (out = Cast<CastMode::CAST_ROUND, OutputDtype>(scalar));
            // 🔥🔥🔥 使用示例 🔥🔥🔥
        };
    };
};
